<template>
  <div class="dashboard animated fadeIn">
    ...
    <!-- <b-card>
      <b-row>
        <b-col sm="5">
          ...
          <div class="small text-muted">Noviembre 2019</div>
        </b-col>
      ...
      <div slot="footer">
        <b-row class="text-center">
          ...
          <b-col class="mb-sm-2 mb-0 d-md-down-none">
            <div class="text-muted">Tasa de Rebote</div>
    ...
    <b-row>
      <b-col md="12">
        <b-card header="Tráfico &amp; Reservas">
          <b-row>
            <b-col sm="12" lg="6">
              <b-row>
                <b-col sm="6">
                  <Callout variant="info">
                    <small class="text-muted">Clientes Nuevos</small><br>
                ...
                <b-col sm="6">
                  <Callout variant="danger">
                    <small class="text-muted">Clientes Frecuentes</small><br>
              ...
              <b-row>
                <b-col sm="6">
                  <Callout variant="warning">
                    <small class="text-muted">Vistas de Página</small><br>
                ...
                <b-col sm="6">
                  <Callout variant="success">
                    <small class="text-muted">Busquedas Organicas</small><br>
              ...
              <ul class="horizontal-bars type-2">
                ...
                <div class="progress-group">
                  <div class="progress-group-header">
                    ...
                    <span class="title">Busquedas Organicas</span>
          ...
          <b-table class="mb-0 table-outline" responsive="sm" hover :items="tableItems" :fields="tableFields" head-variant="light">
            ...
            <div slot="user" slot-scope="item">
              ...
              <div class="small text-muted">
                <span>
                  <template v-if="item.value.new">Nuevo</template>
                  <template v-else>Frecuente</template>
                </span> | Registrado: {{item.value.registered}}
              </div>
            </div>
        ...
        <div class="brand-card">
          ...
          <div class="brand-card-body">
            <div>
              ...
              <div class="text-uppercase text-muted small">contactos</div>
            </div>
            <div>
...
import CardLine2ChartExample from '@/views/dashboard/CardLine2ChartExample'
import CardLine3ChartExample from '@/views/dashboard/CardLine3ChartExample'
import CardBarChartExample from '@/views/dashboard/CardBarChartExample'
...
import CalloutChartExample from '@/views/dashboard/CalloutChartExample'
